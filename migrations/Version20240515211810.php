 ...
 */
final class Version20240515211810 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dining_table (id INT AUTO_INCREMENT NOT NULL, emplacement_id INT NOT NULL, nom VARCHAR(255) NOT NULL, nombre_chaise INT NOT NULL, INDEX IDX_2553802C4598A51 (emplacement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE chaise ADD CONSTRAINT FK_6BB63FF0ECFF285C FOREIGN KEY (table_id) REFERENCES dining_table (id)');
        $this->addSql('ALTER TABLE dining_table ADD CONSTRAINT FK_2553802C4598A51 FOREIGN KEY (emplacement_id) REFERENCES emplacement (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dining_table DROP FOREIGN KEY FK_2553802C4598A51');
